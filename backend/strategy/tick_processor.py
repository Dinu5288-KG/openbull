    ...
    async with state_module.get_state_lock(run_id):
        ...
        for lid, leg in matched_legs:
            ...
            outcome = risk_evaluator.evaluate_leg(
                ...
                sl_type=leg_config.get("sl_type") or "points",
                target_type=leg_config.get("target_type") or "points",
                trail_x_type=(leg_config.get("trail") or {}).get("x_type") or "points",
                trail_y_type=(leg_config.get("trail") or {}).get("y_type") or "points",
